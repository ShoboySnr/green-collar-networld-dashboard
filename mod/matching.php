...
$mergeddonations = $dataRead->matching_transfer_getbyidmatching($mycon, $matching_id, $memberdetails['member_id']);

if ($mergeddonations == null)
{
    $mergeddonations = $dataRead->matching_receive_getbyidmatching($mycon,$matching_id, $memberdetails['member_id']);
}
                                    ...
                                    <div class="portlet-heading <?php if ($row['matchingstatus'] != '0') echo 'bg-primary'; else echo 'bg-success'; ?>">
                                        <h3 class='portlet-title'>
                                           <?php if ($row['matchingstatus'] != '0') echo "New"; else echo "Completed"; ?> Match
                                        </h3>
                                    ...
                                    <div id='bg-primary<?php echo $row['matching_id'] ?>' class='panel-collapse collapse in'>
                                        ...
                                        ?>
                                        <div class="text-center">
                                             <h3>Expiry: <?php echo $expirydate = formatDate(date("Y-m-d H:i:s", strtotime($row['expirydate']) - strtotime("Y-m-d H:i:s")), "yes") ?></h3>
                                        ...
                                        ?>
                                            ...
                                            <hr>
                                            <p class='text-right'>
                                               <button class='btn btn-danger btn-md waves-effect waves-light' data-toggle='modal' data-target=".<?php echo $row['matching_id'] ?>">Details</button>
                                            </div>
                                        </div>
                                        <div class='modal fade <?php echo $row['matching_id'] ?>' tabindex='-1' role='dialog' aria-labelledby='mySmallModalLabel' aria-hidden='true' style='display: none;'>
                                        <div class='modal-dialog modal-lg'>
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                    ...
                                                    <p style='color: #FF0000'><?php if (isset($expirydate)) echo "Expiry: ".$expirydate; ?></p></p>
                                                  ...
                                                  else if ($row['matchingstatus'] =='0') echo 'Confirmed'; ?></p><br><br>

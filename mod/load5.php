...
$mergeddonations = $dataRead->matching_transfer_getbyidmatchingstatus($mycon, '5', $memberdetails['member_id']);

if ($mergeddonations == null)
{
    $mergeddonations = $dataRead->matching_receive_getbyidmatchingstatus($mycon, '5', $memberdetails['member_id']);
}

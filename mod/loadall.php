...
$mergeddonations = $dataRead->matching_transfer_getall($mycon, $memberdetails['member_id']);


if ($mergeddonations == null)
{
    $mergeddonations = $dataRead->matching_receive_getall($mycon, $memberdetails['member_id']);
}

...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2019 at 12:32 AM
...
--
-- Database: `green-collar-networld`
--
...
(20, 'GTB Bank', 'Damilare Shobowale', '0127506509', 11, 5, '2019-04-11 06:48:34', '0000-00-00 00:00:00', 0);
...
CREATE TABLE `donationsreceivable` (
  `donationsreceivable_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
...
CREATE TABLE `members` (
  ...
  `picturestatus` int(11) NOT NULL DEFAULT '0',
  `role` int(11) NOT NULL DEFAULT '0',
  `random_match` int(11) NOT NULL,
  `modifiedon` datetime NOT NULL,
  `modifiedby` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `members` (`member_id`, `username`, `firstname`, `lastname`, `password`, `email`, `phonenumber`, `gender`, `referral_id`, `country`, `expiry`, `address`, `createdon`, `createdby`, `status`, `captcha`, `picturestatus`, `role`, `random_match`, `modifiedon`, `modifiedby`) VALUES
(11, 'admin', 'Damilare', 'Shobowale', '49dc52e6bf2abe5ef6e2bb5b0f1ee2d765b922ae6cc8b95d39dc06c21c848f8c', 'oluwadamilareshobowale@gmail.com', '08136368738', 'Male', 1, 'Nigeria', '2019-04-15 08:33:12', '                                                                    Block 26 Flat 2, Jakande Estate, Oke Afa, Isolo, Lagos', '2019-04-09 06:17:21', 1, 0, '31126', 1, 0, 0, '2019-04-11 06:46:23', 11),
(12, 'Olatem', 'Olalekan', 'Temitope ', 'f2046e7ccbabe430fc3bc827ebd60cddb25f8ca0affd40c8e546c20ddcf06dd7', 'olatemsms@gmail.com', '07065830414', 'Male', 1, 'Nigeria', '2019-04-14 10:26:02', 'Ibadan ', '2019-04-11 10:26:02', 1, 0, '67045', 0, 0, 0, '0000-00-00 00:00:00', 0);
...
ALTER TABLE `accountdetails`
  ADD PRIMARY KEY (`accountdetail_id`),
  ADD KEY `bankaccountname` (`bankaccountname`,`bankaccountnumber`);
...
ALTER TABLE `donations`
  ...
  ADD KEY `donation_ph` (`donation_ph`,`donation_gh`);

--
-- Indexes for table `donationsreceivable`
--
ALTER TABLE `donationsreceivable`
  ADD PRIMARY KEY (`donationsreceivable_id`);
...
ALTER TABLE `matching`
  ...
  ADD KEY `transfer_id` (`transfer_id`,`receive_id`,`thedate`,`expirydate`);
...
--
ALTER TABLE `accountdetails`
  MODIFY `accountdetail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT for table `donationsreceivable`
--
ALTER TABLE `donationsreceivable`
  MODIFY `donationsreceivable_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `matching`
--
ALTER TABLE `matching`
  MODIFY `matching_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
